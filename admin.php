...
<body>
    <div class="content">
        <header>
            <h1 class="judul">Hai, <?= $_SESSION['username'] ?></h1>
            <h3 class="deskripsi"> Kamu adalah admin di web UTS</h3>
        </header>
        <div class="menu">
            <ul>
                <li><a href="admin.php?admin=home">HOME</a></li>
                <li><a href="admin.php?admin=tentang">TENTANG</a></li>
                <li><a href="admin.php?admin=tutorial">TUTORIAL</a></li>
                <li><a href="admin.php?admin=kelola">KELOLA</a></li>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="admin.php?admin=home"><span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html"> <span class="mini-sub-pro">Dashboard v.3</span></a></li>
                                <li><a title="Manage Product" href="admin.php?admin=manage-product"><span class="mini-sub-pro">Manage Product</span></a></li>
                                <li><a title="Product Edit" href="product-edit.html"><span class="mini-sub-pro">Product Edit</span></a></li>
                                <li><a title="Product Detail" href="admin.php?admin=product-detail"><span class="mini-sub-pro">Product Detail</span></a></li>
